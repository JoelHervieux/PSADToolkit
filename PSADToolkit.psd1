@{
    ...
    Description       = 'Boite a outils PowerShell pour automatiser la gestion des identites Active Directory : provisionnement, depart d employe, audit des acces et rapports. Compatible Windows Server 2008 SP2 a 2025 via LDAP.'
